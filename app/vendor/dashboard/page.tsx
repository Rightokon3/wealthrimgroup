...
export default function VendorDashboard() {
  ...
  async function fetchAll() {
    ...
    // Store is optional.
    // Do NOT redirect to /vendor/setup.
    if (!s) {
      setStore(null);
      setProducts([]);
      setOrders([]);
  ...
  const totalVendorPayout = orders
    .filter((o) => o.status === 'delivered')
    .reduce((s, o) => s + o.vendor_payout, 0);
  ...
  const meta = store
    ? CATEGORY_META[store.category]
    : null;

  const productLabel = meta?.productLabel ?? 'Product';
        ...
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-2.5">
            ...
            {store?.logo_url ? (
              ...
              <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-orange-500 to-red-600 flex items-center justify-center font-black text-white flex-shrink-0">
            ...
            <div className="min-w-0">
              <div className="font-bold text-sm truncate">
                {store?.name ?? 'Vendor Dashboard'}
              </div>

              <div className="text-xs text-orange-400 font-semibold">
                {meta?.icon ?? '🏪'} {meta?.label ?? 'Vendor'}
              </div>
            </div>
        ...
        <div className="bg-white border-b border-gray-100 px-6 py-4 flex items-center justify-between sticky top-0 z-20">
          ...
          <div>
            ...
            <p className="text-xs text-gray-400">
              ...
              {tab === 'products' &&
                `${products.length} ${productLabel.toLowerCase()}s listed`}
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        You can continue using your vendor dashboard.
                        Products and orders will appear here once a store
              ...
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 rounded-2xl border border-orange-100 p-5">
                ...
                <div className="grid sm:grid-cols-3 gap-4 text-sm">
                  ...
                  {[
                    ...
                    <div
                      key={r.label}
                      className="bg-white rounded-xl p-3 text-center border border-orange-100"
                    >
                      <div
                        className={`text-xl font-black ${r.color}`}
                      >
                        {r.value}
                      </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm">
                ...
                {orders.slice(0, 5).map((o) => (
                  ...
                  >
                    ...
                    <span
                      className={`text-xs font-bold px-2.5 py-1 rounded-full border ${STATUS_STYLE[o.status]}`}
                    >
            ...
            <div className="space-y-4">
              ...
              {loading ? (
                [1, 2, 3].map((i) => (
                  <div
                    key={i}
                    className="animate-pulse bg-white rounded-2xl h-20 border border-gray-100"
                  />
                ))
              ) : products.length === 0 ? (
                <div className="text-center py-20 bg-white rounded-2xl border border-gray-100">
                  ...
                  <h3 className="font-black text-gray-700 mb-2">
                    No {productLabel}s yet
                  </h3>

                  <p className="text-gray-400 text-sm mb-5">
                    {store
                      ? `Add your first ${productLabel.toLowerCase()} to start selling.`
                      : 'Your products will appear here once your store is connected.'}
                  </p>
                ...
                products.map((p) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <Link
                        href={`/vendor/products/new?id=${p.id}`}
                    ...
                    <div className="flex items-start justify-between gap-4 mb-3">
                      ...
                      <div className="text-right flex-shrink-0">
                        ...
                        <div className="text-xs text-green-600 font-semibold">
                          You get: ₦
                          {o.vendor_payout.toLocaleString()}
                        </div>

                        <div className="text-xs text-gray-400">
                          Fee: ₦
                          {o.platform_fee.toLocaleString()}
                        </div>
            ...
            <div className="space-y-5">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <div className="mt-4 p-3 rounded-xl bg-orange-50 border border-orange-100 text-xs text-orange-700">
                  ...
                  Payments go directly to your registered bank
                  account.
                </div>
                      ...
                      {orders
                        ...
                        .map((o) => (
                          ...
                          >
                            ...
                            <td className="px-4 py-3 font-mono font-bold text-xs text-gray-700">
                              {o.order_number}
                            </td>
                            ...
                            <td className="px-4 py-3 text-green-600 font-black">
                              ₦
                              {o.vendor_payout.toLocaleString()}
                            </td>
                            ...
                            <td className="px-4 py-3">
                              ...
                              <span
                                className={`text-xs font-bold px-2 py-0.5 rounded-full border ${STATUS_STYLE[o.status]}`}
                              >
                                {o.status}
                              </span>
