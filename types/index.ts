...
// Add 'rider' to UserRole
export type UserRole = 'customer' | 'vendor' | 'admin' | 'rider';

// Add 'picked_up' to OrderStatus
export type OrderStatus = 'pending' | 'confirmed' | 'preparing' | 'ready' | 'picked_up' | 'on_the_way' | 'delivered' | 'cancelled' | 'refunded'|'picked_up';
...
// Extend Order with rider fields
// Add these two fields to your existing Order interface:
// rider_id: string | null;
// riders?: Pick<Rider, 'full_name' | 'phone' | 'vehicle_type'>;